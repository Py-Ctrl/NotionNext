...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '7265aafc82f9483b9704261900b4f9ec',
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个UP主, 有一个小天才D3(倒腾中), 欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Patch_Setup', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.msgzs.cloudns.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'UP主, 博客, Windows, Python, XTC', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'feed@feed.msgzs.cloudns.org', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/168058198', // B站主页
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'u6p21ca3leI0VEHYGg8qX',
  ...
  COMMENT_VALINE_PLACEHOLDER:
    process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '评个论吧~', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
