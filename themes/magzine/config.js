const CONFIG = {
  ...
  MAGZINE_SOCIAL_CARD_TITLE_1: 'B站主页',
  MAGZINE_SOCIAL_CARD_TITLE_2: '点个三连、关注',
  MAGZINE_SOCIAL_CARD_TITLE_3: '投喂下吧！',
  MAGZINE_SOCIAL_CARD_URL: 'https://space.bilibili.com/168058198',
  ...
  MAGZINE_FOOTER_LINKS: [
    {
      ...
      menus: [
        {
          title: '关于作者',
          href: 'https://msgzs.cloudns.org/about'
        }
      ]
    },
  ],
