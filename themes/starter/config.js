...
const CONFIG = {
  ...
  // 顶部右侧导航暗流
  STARTER_NAV_BUTTON_1_TEXT: 'Sign In(没做)',
  STARTER_NAV_BUTTON_1_URL: '/sign-in',

  STARTER_NAV_BUTTON_2_TEXT: 'Sign Up(没做)',
  ...
  STARTER_BLOG_TITLE: '博客',
  STARTER_BLOG_COUNT: 9, // 首页博文区块默认展示前3篇文章
  STARTER_BLOG_TEXT_1: '最近文章',
  ...
  STARTER_FOOTER_LINK_GROUP: [
    {
      TITLE: '关于我们',
      LINK_GROUP: [
        { TITLE: '主页', URL: 'https://msgzs.cloudns.org' },
        { TITLE: '关于', URL: 'https://msgzs.cloudns.org/about' },
      ]
    },
    // {
    //   TITLE: '功能特性',
